...
final readonly class AddHandler implements NumberHandler
{
    ...
    {
        $left = $deferredResolver->number($this->add->left, $visitor);
        $right = $deferredResolver->number($this->add->right, $visitor);
