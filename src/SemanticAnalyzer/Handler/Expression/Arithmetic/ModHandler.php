...
final readonly class ModHandler implements NumberHandler
{
    ...
    {
        $left = $deferredResolver->number($this->mod->left, $visitor);
        $right = $deferredResolver->number($this->mod->right, $visitor);
